...
class Epub3Adapter(var context: LibraryActivity, var epub3: ArrayList<Book>, var recyclerViewItemClickListener: RecyclerViewItemClickListener) : RecyclerView.Adapter<Epub3ViewHolder>() {
